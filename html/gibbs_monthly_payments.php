...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    ...
    <script type="text/javascript" src="/subscription/js/gibbs_monthly_payments.js?v=<?= Utility::BUILD_NO ?>"></script>
...
var password = '<?= $password ?>';
  ...
  <body onload="initialise();">
    ...
    <?= Header::get_header_with_user_info($access_token, 'Monthly payments', 'fa-square-dollar') ?>
    <div class="content">
      <div class="toolbar">
        <label for="uniqueIdEdit">Unique ID:
          <input type="text" id="uniqueIdEdit" value="<?= Utility::get_random_string() ?>" />
        </label>
        ...
        <button type="button" class="wide-button" onclick="createMonthlyPayments();"><i class="fa-solid fa-square-dollar"></i> Create payments</button>
        <br />
        <p class="help-text">
