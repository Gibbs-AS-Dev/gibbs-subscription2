...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    ...
    <script type="text/javascript" src="/subscription/js/gibbs_payment_status.js?v=<?= Utility::BUILD_NO ?>"></script>
...
var password = '<?= $password ?>';
  ...
  <body onload="initialise();">
    ...
    <?= Header::get_header_with_user_info($access_token, 'Payment status', 'fa-message-question') ?>
    <div class="content">
      <div class="toolbar">
        <label for="bulkIdEdit">Bulk ID:
          <input type="text" id="bulkIdEdit" />
        </label>
        <label for="userGroupIdEdit">User group ID:
          <input type="text" id="userGroupIdEdit" />
        </label>
        <button type="button" class="wide-button" onclick="readBulkPaymentStatus();"><i class="fa-solid fa-message-question"></i> Get status</button>
      </div>
