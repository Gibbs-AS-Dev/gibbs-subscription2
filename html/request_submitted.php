      ...
      <div id="tab_0" class="tab">
        <div class="area-box confirmation-box">
          ...
          <div class="separator-box">
            <h2><?= $text->get(1, 'Takk for henvendelsen, $0!', array($current_user->first_name)) ?></h2>
          </div>
          <div class="form-element">
            <p>
              <?= $text->get(2, 'Du kan nå lukke denne siden. Vi kontakter deg snart.') ?>
            </p>
          </div>
          <div class="centered-button">
            <button type="button" class="wide-button" onclick="Utility.displaySpinnerThenGoTo('/subscription/html/user_dashboard.php');"><?= $text->get(3, 'Gå til Min side') ?>&nbsp;&nbsp;<i class="fa-solid fa-chevron-right"></i></button>
          </div>
        </div>
      </div>
    </div>
