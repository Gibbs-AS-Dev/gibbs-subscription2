...
<div id="tv-view" class="tv_view_main">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-fields">
                    <label>Visning <span class="settings-info" data-content="Det kan ta opp til 15min før kalenderen oppdateres"> <i class="fa fa-question-circle"></i></span></label>
        ...
        <div class="row">
            ...
            <div class="col-md-6" <?php if(count($group_data) < 1 || empty($app_fieldss)){?>style="display:none"<?php } ?>>
                <div class="form-fields">
                    <label>Vis i kalender  </label>
                    <select id="fields-info-tv" name="fields-info-tv">
                    <option value="">Velg</option>
