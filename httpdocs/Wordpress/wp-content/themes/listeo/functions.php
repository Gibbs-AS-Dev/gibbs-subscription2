...
function listeo_scripts() {
	...
	wp_register_style( 'Gibbs access management', get_template_directory_uri(). 'path/file' );
	wp_register_style( 'Gibbs admin calendar', get_template_directory_uri(). 'path/file' );
	wp_register_style( 'Gibbs application form', get_template_directory_uri(). 'path/file' );
	wp_register_style( 'Gibbs rules', get_template_directory_uri(). 'path/file' );
	wp_register_style( 'Gibbs user management', get_template_directory_uri(). 'path/file' );
	wp_register_style( 'Gibbs weekly view', get_template_directory_uri(). 'path/file' );
	wp_register_style( 'Listeo core plugin', get_template_directory_uri(). 'path/file' );
	...
	wp_enqueue_script( 'listeo-custom2', get_template_directory_uri() . '/js/custom.js', array('jquery'), '20170821', true );
	...
	wp_localize_script( 'listeo-custom2', 'wordpress_date_format', $convertedData );


	$ajax_url = admin_url( 'admin-ajax.php', 'relative' );
	wp_localize_script( 'listeo-custom2', 'listeo',
    array(
        'ajaxurl' 				=> $ajax_url,
...
// function custom_arg($args){

//  $args['bookings_author'] = 1;
//  return $args;
// }
// add_filter('listeo_core_my_bookings_args','custom_arg',1);
