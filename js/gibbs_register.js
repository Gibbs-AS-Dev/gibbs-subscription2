...
var newIndividualButton, newCompanyButton, individualDataBox, companyDataBox, userNameEdit,
  firstNameEdit, lastNameEdit, newCompanyNameEdit, newCompanyIdEdit, phoneEdit, passwordEdit,
  submitButton;
...
function initialise()
{
  ...
  Utility.readPointers(['newIndividualButton', 'newCompanyButton', 'individualDataBox',
    'companyDataBox', 'userNameEdit', 'firstNameEdit', 'lastNameEdit', 'newCompanyNameEdit',
    'newCompanyIdEdit', 'phoneEdit', 'passwordEdit', 'submitButton']);
