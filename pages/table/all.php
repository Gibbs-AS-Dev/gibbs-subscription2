<?php
  ...
  $requests = $wpdb->get_results("select * from $table_subscription_manual_requests order by id DESC");
?>  
<div class="vs-hidden main-table-bk">
  <div class="form-group has-search">
    <span class="fa fa-search form-control-feedback"></span>
    <input type="text" class="form-control" placeholder="Search" id="searchAll">
  </div>
  <table id="all_bk" class="display nowrap" style="width:100%">
      <thead>
          <tr>
              <th>Name</th>
              <th>Email</th>
