<?php
  ...
  $requests = $wpdb->get_results("select * from $table_subscription_manual_requests where status='cancelled'  order by id DESC");
?> 
<div class="vs-hidden main-table-bk">
  <div class="form-group has-search">
    <span class="fa fa-search form-control-feedback"></span>
    <input type="text" class="form-control" placeholder="Search" id="searchLost">
  </div>
  <table id="lost_bk" class="display nowrap" style="width:100%">
      <thead>
          <tr>
              <th>Name</th>
              <th>Email</th>
            ...
            <tr>
                ...
                <td>
                  <form method="post" action="">
                    ...
                    <input type="hidden" name="active" value="lost">
